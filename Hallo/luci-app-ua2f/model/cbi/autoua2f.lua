...
o3 = e:option(ListValue, "handle_intranet", translate("处理内网流量"), translate("如果你的路由器是在内网中，且你想要处理内网中的流量，那么请启用这一选项"))
o3:value("1", "启用")
o3:value("0", "禁用")
o3.default = "1"
...
o5 = e:option(ListValue, "handle_mmtls", translate("处理微信流量"), translate("微信的流量通常是加密的因此无需处理"))
o5:value("1", "启用")
o5:value("0", "禁用")
o5.default = "1"
...
o7 = e:option(Value, "Custom_UA", translate("自定义用户代理"), translate("自定义用户代理字符串，长度不足则填充空格，过长则截取与原来长度相同的子串"))
