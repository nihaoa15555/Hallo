...
m = Map("weblogin", translate("校园网认证"))
m:section(SimpleSection).template = "weblogin/weblogin"
...
m:section(SimpleSection).template = "weblogin/weblogin_button"

local apply = luci.http.formvalue("cbi.apply")
if apply then
	io.popen("/etc/init.d/weblogin start")
end
