...
IFCONFIG="$(uci get weblogin.config.interface)"
USER_ACCOUNT="$(uci get weblogin.config.user_account)"
USER_PASSWORD="$(uci get weblogin.config.user_password)"
USER_ACCOUNT2="$(uci get weblogin.config.user_account2)"
USER_PASSWORD2="$(uci get weblogin.config.user_password2)"
alternative="$(uci get weblogin.config.alternative)"
TIME="$(uci get weblogin.config.time)"
